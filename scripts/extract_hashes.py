...
parser.add_argument('--game', required=True, type=str, default="h3", help="Specify the game. Possible options are alpha, h1, h2, h3, beta, and sa.")
parser.add_argument('--input', type=str, nargs='+', required=True, help="Path to a game or multiple game's runtime folders")
parser.add_argument('--output', type=str, default="new_hashes.txt", help="Output folder and/or name. Defaults to new_hashes.txt.")
...
def extractHashes(game, searchDirs):
	hashes = []
	for d in searchDirs:
